...
const contact = () => {
  return (
    ...
    <div>
        ...
        <div className=" w-full min-h-[80vh] pt-28 relative py-10" >

            <Image alt='bg image' src="/images/image.png" fill={true} className="-z-10 opacity-90 blur-sm object-cover"/>
            ...
            <div className="justify-center  items-center  flex flex-col md:flex-row md:h-[80vh] ">
                ...
                <h1 className=" font-extrabold text-2xl md:text-4xl text-white shadow-white">We are here Help!</h1>
                <p className="font-semibold text-lg md:text-2xl shadow-white text-white py-5">We understand that you may have questions or concerns about our services, and we want to make it as easy as possible for you to get in touch with us.
            ...
            <div className="w-[80%] h-[50%] md:w-[50%] md:min-h-[65%] lg:w-[25%] lg:h-[50%] bg-white p-10 shadow-2xl rounded-lg md:transition ease-in-out hover:scale-95 duration-700 md:mr-16">  
                <h5 className="text-center font-extrabold text-2xl">Contact Us</h5>
                ...
                <p className="font-semibold text-lg">meenu.ca@gmail.com</p>
                </div>
                ...
                <p className="font-semibold text-lg">9810763856</p>
                </div>
