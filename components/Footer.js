            ...
            <div className='bg-gray-300 p-5'>
                ...
                <div className='max-w-screen-lg ml-auto mr-auto sm:flex sm:justify-between sm:items-center  '>
                    ...
                    <div className='flex items-center justify-center sm:inline space-x-3 pt-5 md:pt-0'>
                        ...
                        <Link href="https://instagram.com/meenu.sethii" legacyBehavior><a href="https://instagram.com/meenu.sethii" target="_blank" rel="noreferrer"><img className='h-12 inline' src="https://img.icons8.com/ios/90/null/whatsapp--v1.png"/></a></Link>
                    </div>
                </div>
            </div>
